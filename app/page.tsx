...
export default function QuitoFreshBotanicalFinal() {
  ...
  return (
    <div style={{ backgroundColor: '#FFFFFF', color: '#1A1A1A', fontFamily: '"Montserrat", sans-serif', margin: 0 }}>
      ...
      <header style={{ height: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: '0 20px', position: 'relative' }}>
        <div style={{ position: 'absolute', top: '160px', right: '100px', fontSize: '12px', letterSpacing: '2px', color: '#666', border: '1px solid #EEE', padding: '5px 10px', borderRadius: '5px' }}>EST. 2026</div>
      ...
      <section style={{ padding: '100px 40px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '50px', maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
          <div>
              <div style={{ fontSize: '60px' }}>⚙️</div> {/* Reemplaza con icono real */}
          ...
          <div>
              <div style={{ fontSize: '60px' }}>🌿</div> {/* Reemplaza con icono real */}
      ...
      <div className="sidebar">
        {/* Lógica del carrito idéntica a la anterior, solo ajusté estilos menores */}
      </div>
    </div>
  );
}
