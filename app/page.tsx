...
export default function QuitoFreshLimpio() {
  ...
  return (
    <div style={{ backgroundColor: '#FFFFFF', color: '#1A1A1A', fontFamily: 'Inter, sans-serif', position: 'relative', overflowX: 'hidden' }}>
      ...
      {/* ICONOS TÉCNICOS - Sin distracciones */}
      ...
      {/* INFO CORPORATIVA - Limpia con acentos en los bordes de la sección */}
      <section style={{ position: 'relative', padding: '100px 20px', maxWidth: '1200px', margin: '0 auto' }}>
        {/* Usamos el splash de mora para decorar el fondo de esta sección únicamente */}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px', position: 'relative', zIndex: 2 }}>
          <div style={{ background: '#F9F9F9', padding: '50px', borderRadius: '40px' }}>
            ...
            <p style={{ fontSize: '15px', lineHeight: 1.8, color: '#444' }}>Nutrir a nuestra comunidad con extractos puros de la tierra andina, fomentando un estilo de vida consciente y natural.</p>
          </div>
          <div style={{ background: '#8CC63F', padding: '50px', borderRadius: '40px', color: 'white' }}>
            <h3 className="text-bold" style={{ marginBottom: '20px' }}>Llevando Felicidad</h3>
          ...
          <div style={{ background: '#F9F9F9', padding: '50px', borderRadius: '40px' }}>
            ...
            <p style={{ fontSize: '15px', lineHeight: 1.8, color: '#444' }}>Ser líderes en bienestar premium en Ecuador, reconocidos por nuestra calidad inigualable.</p>
          </div>
        </div>
      </section>

      {/* SURTIDO - Enfoque total en el producto */}
